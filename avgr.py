    ...
    if key=="same salt":
        ...
        for i in range(2,snapshots_end):
            ...
            for f in range(1,len(file)):
                ...
                ani.append(float(file[f].strip().split()[2]))
                cat.append(float(file[f].strip().split()[3]))
                litani.append(float(file[f].strip().split()[4]))
                litcat.append(float(file[f].strip().split()[5]))
                litlit.append(float(file[f].strip().split()[6]))
            sumpair=pair.copy()
            sumani=ani.copy()
            sumcat=cat.copy()
            sumlitani=litani.copy()
    ...
    if key=="diff salt":
        ...
        for i in range(2,snapshots_end):
            ...
            for f in range(1,len(file)):
                ...
                litcat.append(float(file[f].strip().split()[5]))
                litlit.append(float(file[f].strip().split()[6]))
                saltcat.append(float(file[f].strip().split()[7]))
                saltani.append(float(file[f].strip().split()[8]))
                saltsalt.append(float(file[f].strip().split()[9]))
                saltlitt.append(float(file[f].strip().split()[10]))
            sumpair=pair.copy()
            sumani=ani.copy()
            sumcat=cat.copy()
            sumlitani=litani.copy()
