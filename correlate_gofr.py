...
def splitflux(filename,key): #filename is a variable that represents a string
        ...
        return J
def molsplitflux(filename,key): #filename is a variable that represents a string
        Ncat=100
        qcat=1
        Nani=100
        qani=-1
                ...
                if 'id' in f:
                        ...
                        if str(array[0])=="ITEM:":
                                ...
                                if key=='diff salt' or key=="same salt":
                                        ...
                                        Jz_salt=0
                                        Jz_lith=0
                                Jcat.append([Jx_cat,Jy_cat,Jz_cat])
				Jani.append([Jx_ani,Jy_ani,Jz_ani])
				Jsalt.append([Jx_salt,Jy_salt,Jz_salt])
				Jlith.append([Jx_lith,Jy_lith,Jz_lith])
                                J.append([Jx_cat+Jx_ani+Jx_salt+Jx_lith, Jy_cat+Jy_ani+Jy_salt+Jy_lith, Jz_cat+Jz_ani+Jz_salt+Jz_lith])
                                catarray=[]
                                anaarray=[]
                                saltanarray=[]
                                ...
                                print("Error in the order of the ions and the formatting of the dump files")
        return J, Jcat, Jani, Jsalt, Jlith
